Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/geordasche/react-native-linkedin-login.git"
  ...
  s.source = { :git => "https://github.com/geordasche/react-native-linkedin-login.git", :tag => "#{s.version}" }
